...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <!-- loader-->
        <link href="{{ asset('contents/backend') }}/css/pace.min.css" rel="stylesheet" />
        <script src=" {{ asset('contents/backend') }}/js/pace.min.js"></script>
        <!--favicon-->
        <link rel="icon" href=" {{ asset('contents/backend') }}/images/favicon.ico" type="image/x-icon" />
        <!-- simplebar CSS-->
        <link href=" {{ asset('contents/backend') }}/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
        <!-- Bootstrap core CSS-->
        <link href=" {{ asset('contents/backend') }}/css/bootstrap.min.css" rel="stylesheet" />
        <!-- animate CSS-->
        <link href=" {{ asset('contents/backend') }}/css/animate.css" rel="stylesheet" type="text/css" />
        <!-- Icons CSS-->
        <link href=" {{ asset('contents/backend') }}/css/icons.css" rel="stylesheet" type="text/css" />
        <!-- Metismenu CSS-->
        <link href=" {{ asset('contents/backend') }}/plugins/metismenu/css/metisMenu.min.css" rel="stylesheet" />
        @stack('ccss')
        <!-- Custom Style-->
        <link href=" {{ asset('contents/backend') }}/css/app-style.css" rel="stylesheet" />
        {{-- custom js --}}
        
        {{-- custom css --}}
        <link rel="stylesheet" href="{{ asset('contents/backend') }}/custom.css">
        {{-- SweetAlart cdn --}}
        ...
        <div id="wrapper">
            ...
            <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
                <div class="brand-logo">
                    <img src=" {{ asset('contents/backend') }}/images/logo-icon.png" class="logo-icon" alt="logo icon" />
                ...
                <nav class="navbar navbar-expand fixed-top">
                    ...
                    <ul class="navbar-nav align-items-center right-nav-link ml-auto">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                <div class="avatar"><img class="align-self-start mr-3" src=" {{ asset('contents/backend') }}/images/avatars/avatar-5.png" alt="user avatar" /></div>
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                <div class="avatar"><img class="align-self-start mr-3" src=" {{ asset('contents/backend') }}/images/avatars/avatar-6.png" alt="user avatar" /></div>
                                                <div class="media-body">
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                <div class="avatar"><img class="align-self-start mr-3" src=" {{ asset('contents/backend') }}/images/avatars/avatar-7.png" alt="user avatar" /></div>
                                                <div class="media-body">
                                    ...
                                    <li class="list-group-item">
                                        <a href="javaScript:void();">
                                            <div class="media">
                                                <div class="avatar"><img class="align-self-start mr-3" src=" {{ asset('contents/backend') }}/images/avatars/avatar-8.png" alt="user avatar" /></div>
                                                <div class="media-body">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" data-toggle="dropdown" href="javascript:void();">
                                <span class="user-profile"><img src=" {{ asset('contents/backend') }}/images/avatars/avatar-13.png" class="img-circle" alt="user avatar" /></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="dropdown-item user-details">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src=" {{ asset('contents/backend') }}/images/avatars/avatar-13.png" alt="user avatar" /></div>
                                            <div class="media-body">
    ...
    aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <script src="{{ asset('contents/backend') }}/js/popper.min.js"></script>
     <script src="{{ asset('contents/backend') }}/custom.js"></script>
     <script src="{{ asset('contents/backend') }}/js/bootstrap.min.js"></script>
   
     <!-- simplebar js -->
     <script src="{{ asset('contents/backend') }}/plugins/simplebar/js/simplebar.js"></script>
     <!-- Metismenu js -->
     <script src="{{ asset('contents/backend') }}/plugins/metismenu/js/metisMenu.min.js"></script>
     <!-- loader scripts -->
     {{-- <script src="{{ asset('contents/backend') }}/js/jquery.loading-indicator.html"></script> --}}
     <!-- Custom scripts -->
     <script src="{{ asset('contents/backend') }}/js/app-script.js"></script>
     @stack('cjs')
 </html>
