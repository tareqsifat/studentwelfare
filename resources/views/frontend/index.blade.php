        ...
        <div class="row">
            <div class="col-12" style="display: flex; align-items: center">
                <div class="classbutton">
                    <div class="row">
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">৪র্থ শ্রেনী</h3></a>
                        </div>
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">৫ম শ্রেনী</h3></a>
                        </div>
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">৬ষ্ঠ শ্রেনী</h3></a>
                        </div>
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">৭ম শ্রেনী</h3></a>
                        </div>
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">৮ম শ্রেনী</h3></a>
                        </div>
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">৯ম শ্রেনী</h3></a>
                        </div>
                        <div class="col-3">
                            <a href="{{ route('curriculam_route') }}"><h3 class="reg_form_btn">১০ম শ্রেনী</h3></a>
                        </div>
                    </div>
